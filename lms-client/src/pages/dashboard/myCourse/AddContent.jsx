...
import { TextField, Button, Box, IconButton, Typography, Collapse, Paper, Stack, FormControlLabel, Checkbox, Select, MenuItem } from '@mui/material';
...
const AddContent = ({ course, onClose }) => {
  ...
  return (
    <>
      ...
      <CButton style={{ width: '100%', mt: 2 }} loading={mutation.isPending} contained onClick={handleSave}>Save Course Content</CButton>
    </>
  );
};
